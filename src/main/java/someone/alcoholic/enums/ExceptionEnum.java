...
public enum ExceptionEnum {
    ...
    FORBIDDEN("auth-007", "접근 권한이 없습니다."),
    ...
    UNAUTHORIZED("auth-013", "로그인이 필요합니다."),
    ...
    CATEGORY_NOT_FOUND("common-002", "존재하지 않는 카테고리입니다."),
    PAGE_NOT_FOUND("common-003", "존재하지 않는 게시물입니다."),
    REPLY_NOT_FOUND("common-004", "존재하지 않는 댓글입니다."),
    ...
    FILE_NOT_EXISTS("file-002", "저장할 파일이 없습니다."),
