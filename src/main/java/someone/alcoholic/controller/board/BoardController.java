...
public class BoardController {
    ...
    public ResponseEntity<ApiResult<BoardDto>> getBoard(@PathVariable int boardSeq) {
    ...
    @Secured("ROLE_USER")
    @PostMapping("/board")
    public ResponseEntity<ApiResult<Board>> addBoard(@RequestBody BoardInputDto boardInputDto, Principal principal) {
    ...
    public ResponseEntity<ApiResult> deleteBoard(Principal principal, @PathVariable int boardSeq) {
