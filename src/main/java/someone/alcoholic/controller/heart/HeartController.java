...
public class HeartController {
    ...
    public ResponseEntity<ApiResult> saveBoardHeart(HttpServletRequest request, @PathVariable @Positive Long boardSeq) {
    ...
    public ResponseEntity<ApiResult> deleteBoardHeart(HttpServletRequest request, @PathVariable @Positive Long boardSeq) {
