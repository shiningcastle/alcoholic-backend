...
public class MailController {
    ...
    public ResponseEntity<ApiResult> sendAuthEmail(@PathVariable @NotEmpty @ApiParam(value = "인증유형 타입", required = true, example = "signup, id, password") String type,
    ...
    public void checkAuthEmail(@PathVariable @NotEmpty @ApiParam(value = "인증유형 타입", required = true, example = "signup, id, password") String type,
    ...
    public ResponseEntity<ApiResult> checkAuthEmail(@PathVariable @NotEmpty @ApiParam(value = "인증유형 타입", required = true, example = "signup, id, password") String type, @RequestParam @Email(message = "이메일은 필수 입력 값입니다.") String email) {
